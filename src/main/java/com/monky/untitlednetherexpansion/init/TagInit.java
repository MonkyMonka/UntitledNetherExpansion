...
public final class TagInit {
    public static final class Blocks {
        ...
        private static Tag.Named<Block> mod(String path) {
            return BlockTags.bind(new ResourceLocation(UntitledNetherExpansion.MOD_ID, path).toString());
        }
    ...
    public static final class Items {
        ...
        private static Tag.Named<Item> mod(String path) {
            return ItemTags.bind(new ResourceLocation(UntitledNetherExpansion.MOD_ID, path).toString());
        }
