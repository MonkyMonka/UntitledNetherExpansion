...
@OnlyIn(Dist.CLIENT)
public final class WayfinderItemProperty implements ClampedItemPropertyFunction {
    ...
    public float unclampedCall(@Nonnull ItemStack stack, @Nullable ClientLevel world, @Nullable LivingEntity livingEntity, int p) {
        ...
        if (pos != null
                && world.dimension().location().toString().equals(WayfinderItem.getDimension(stack))
